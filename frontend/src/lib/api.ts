...
export type InvestFixedIncomeProduct = {
  ...
  quote_quality_label: string | null;
  quote_type: string | null;
  quote_as_of: string | null;
  quote_stale_after: string | null;
  ...
  bid_yield_pct: string | null;
  ask_yield_pct: string | null;
  mid_yield_pct: string | null;
  last_yield_pct: string | null;
