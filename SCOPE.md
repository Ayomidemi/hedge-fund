...
# 24. Strategy & Hedging Scope

## Version 1.0

## 24.1 Purpose

Pease Capital will operate as a **multi-strategy hedge fund** with two distinct functions:

### Alpha generation

Strategies designed to produce returns.

### Hedging

Strategies designed to reduce unwanted portfolio risks.

These two functions must remain separate.

The fund should always be able to answer:

> **Where is the expected return coming from?**

and:

> **Which risks are we accepting to obtain that return?**

No trade should be approved if either question cannot be answered clearly.

---

## 24.2 Strategy Architecture
...
```text
              ...
              ┌───────────────┼───────────────┐
              │               │               │
          ALPHA PODS      HEDGE ENGINE      TREASURY
              │               │               │
       Generate return   Remove unwanted    Cash /
...
Pease Capital will initially operate five alpha strategy families:

1. Regime-Aware Global Macro
2. Cross-Asset Trend Following
3. Quantitative Equity Ranking
4. Fundamental / Catalyst Equity
5. Relative Value / Capital Rotation

A separate Central Hedge Engine will manage unwanted exposures generated by these strategies.

---

## 24.3 Strategy Pod A — Regime-Aware Global Macro

### Objective

Allocate capital according to changing macroeconomic and market regimes.

The strategy asks:

> **What economic environment are we currently in, and which assets are likely to perform best under that environment?**

---

### Core regime variables
...
Growth Rising       Goldilocks     Inflationary Growth

Growth Falling      Deflation      Stagflation
```

Additional volatility and liquidity states may sit on top of this framework.
...
Recommended Macro Bias:
Risk-on / moderately defensive
```
...
The strategy does not need to perfectly forecast macroeconomic data.

Its edge should come from identifying:

* regime transitions;
* changes in probability;
* divergences between market pricing and economic conditions;
* assets incorrectly positioned for the emerging regime.

---

## 24.4 Strategy Pod B — Cross-Asset Trend Following

### Objective

Capture persistent directional movements across liquid markets.

The strategy asks:

> **Which markets are displaying statistically persistent trends?**
...
The strategy assumes that market trends sometimes persist longer than simple efficient-market reasoning would suggest.

Pease Capital will test whether combining multiple horizons and regime information improves this effect.

---

## 24.5 Strategy Pod C — Quantitative Equity Ranking

### Objective

Systematically identify the strongest securities within the investable equity universe.

The question is not:

> Will AAPL rise tomorrow?

It is:

> **Which available companies are currently most attractive relative to the other companies we could own?**
...
Ticker Analyst then conducts deeper research on high-ranking candidates.
...
* transparent weighted factor models;
* logistic regression;
* XGBoost;
* quantile regression.
...
```text
Long top-ranked securities
Short bottom-ranked securities
```

This could eventually become a market-neutral strategy.

---

## 24.6 Strategy Pod D — Fundamental / Catalyst Equity

### Objective

Identify securities where the fund believes market expectations differ materially from underlying business reality.

The strategy asks:

> **What does the market appear to believe, and where might that belief be wrong?**

---

### Research process

Ticker Analyst supplies:
...
## 24.7 Strategy Pod E — Relative Value / Capital Rotation

### Objective

Find opportunities created when economic value, investor capital or relative strength shifts from one asset, company or industry toward another.

The strategy asks:

> **If something is losing, who benefits?**

This is closely integrated with Market Radar.

---

## 24.8 Relationship Types
...
### Input-cost relationships

```text
Oil prices ↓
→ energy producers potentially suffer
→ airlines potentially benefit
```
...
```text
Energy weakens
→ capital may rotate into another sector
```
...
```text
NGN weakens
→ import-heavy companies may suffer
→ foreign-currency earners may benefit
```
...
→ chip suppliers potentially benefit
→ hardware manufacturers may suffer
```
...
```text
Rates rise
→ rate-sensitive growth companies may weaken
→ some financial companies may benefit
```

---

## 24.9 Relationship Research

Relationships should be tested using:
...
Historical Pattern:
Positive response in 61% of comparable events

Sample:
42 events

Current Confirmation:
Transportation relative strength increasing

Research Priority:
HIGH
```

This becomes a research candidate, not an automatic trade.

---

## 24.11 Central Hedge Engine

The Central Hedge Engine exists to remove portfolio risks that are not part of Pease Capital's intended investment thesis.

It does not exist simply to reduce volatility indiscriminately.

The central question is:

> **Which risks are intentional and which risks are accidental?**

---

## 24.12 Exposure Classification

Every major portfolio exposure should be classified as:
...
```text
Technology Exposure      +28%

Intentional              +15%
Unintentional            +13%

Potential hedge target   ~13%
```

---

## 24.13 Hedge Strategy A — Cash / Treasury Reserve

### Purpose

Reduce total portfolio risk without introducing complex instruments.

Cash should be treated as an active allocation.

The portfolio may increase cash when:
...
* Treasury ETFs where appropriate.

This will be one of Pease Capital's most important early-stage hedges.

---

## 24.14 Hedge Strategy B — Diversifying Assets

### Purpose

Reduce portfolio sensitivity to specific economic environments using assets with different return drivers.
...
The hedge must remain regime-aware.

Example:

```text
Growth shock
→ Treasuries may hedge equities

Inflation shock
→ Equities and long Treasuries may both decline
→ commodities/gold may behave differently
```

Diversification relationships must therefore be monitored dynamically.

---

## 24.15 Hedge Strategy C — Market Beta Hedge

### Purpose

Reduce broad-market exposure when the fund's actual thesis concerns security selection rather than market direction.
...
* SPY;
* QQQ;
* index futures eventually.

This allows Pease Capital to isolate more of its desired alpha exposure.

---

## 24.16 Hedge Strategy D — Sector Hedge

### Purpose

Separate company-specific conviction from sector-wide risk.
...
```text
Long selected technology names
Short technology sector exposure
```

The resulting thesis becomes:

> Selected companies outperform their sector.
...
## 24.17 Hedge Strategy E — Pair / Relative-Value Hedge

### Purpose

Remove common industry exposure when expressing a relative company view.
...
## 24.18 Hedge Strategy F — FX Hedge

### Purpose

Separate investment returns from unwanted currency exposure.

For an international investment:
...
Risk Centre should therefore track:
...
## 24.19 Hedge Strategy G — Volatility / Tail Hedge

### Purpose

Reduce extreme portfolio losses during severe market stress.
...
These will not initially be deployed because persistent option protection can create significant performance drag.

---

### Activation

Future tail hedges may become conditional on:

```text
Stress regime probability
+
...
rather than permanently buying insurance.

---

## 24.20 Hedge Strategy H — Factor Hedging

### Purpose

Understand and reduce unintended systematic factor exposures.

Risk Centre should eventually decompose the portfolio into:
...
The fund then chooses which exposures are intentional.

---

## 24.21 Hedge Decision Hierarchy

Before introducing a hedge, Risk Centre should ask:

```text
                  RISK DETECTED
                       │
                       ▼
             Do we need this exposure?
                       │
              NO ──────┼────── YES
               │                │
               ▼                ▼
        Reduce position     Keep exposure
                                │
                      Can diversification
                         solve the risk?
                                │
                       YES ─────┼──── NO
                        │              │
                        ▼              ▼
                   Diversifier     Explicit Hedge
                                       │
                                       ▼
                                  Stress Test
```

Pease Capital should never use a complicated hedge when simply reducing the underlying position is better.

---

## 24.22 Hedge Selection Engine

For each identified portfolio risk, the engine should eventually compare potential hedges using:
...
Reduce equities + increase cash
```

---

## 24.23 Interaction With Market Radar

Market Radar helps strategies by identifying:
...
Risk:
Existing energy positions exposed
```

---

## 24.24 Interaction With Ticker Analyst

Ticker Analyst determines:

> Is the individual security attractive?

Strategy Pods determine:

> Does the security fit a strategy?

Portfolio Engine determines:

> Does the trade improve the portfolio?

Risk Centre determines:

> Is the resulting risk acceptable?

Hedge Engine determines:

> Which unwanted exposures should be reduced?

---

## 24.25 Interaction With Opportunity Queue

Every strategy idea should move through:
...
The Queue should record the originating strategy.
...
## 24.26 Strategy Capital Allocation

Each alpha strategy receives a separate virtual capital allocation.

Example future structure:

```text
Macro Regime               25%
Cross-Asset Trend          20%
Quant Equity               25%
Fundamental / Catalyst     20%
Capital Rotation           10%
```

These are **not permanent allocation targets**.

Capital should be dynamically allocated based on:
...
A strategy may not exceed its risk budget simply because its model has high conviction.

---

## 24.28 Strategy Lifecycle
...
Strategies can also move backwards:
...
## 24.29 Strategy Promotion Criteria

A strategy should be evaluated on:
...
## 24.30 Alpha Attribution

Every dollar of portfolio P&L should eventually be attributable to:
...
A hedge producing a small loss may still have performed correctly if it reduced portfolio downside risk.

---

## 24.31 Hedge Attribution

Evaluate hedges separately.
...
This prevents hedges from being judged simply because they lost money while the portfolio gained.

---

## 24.32 Initial Live Strategy Scope

With the initial capital base:
...
## 24.33 Initial Live Hedge Scope
...
## 24.34 Research / Paper Scope

Initially research only:
...
The systems can be built before the strategies are allowed to deploy live capital.

---

## 24.35 Strategy Registry

Every strategy should have a permanent record.
...
## 24.37 Central Portfolio Philosophy

Pease Capital should not simply combine whichever trades individual strategies want.
...
## 24.38 Final Strategy Architecture
...
```text
       ...
       ┌───────────────────┼───────────────────┐
       │                   │                   │
 SYSTEMATIC ALPHA    DISCRETIONARY ALPHA   HEDGE BOOK
       │                   │                   │
       ├ Macro             ├ Fundamental      ├ Cash
       ├ Trend             ├ Catalysts        ├ Treasury
       ├ Quant Equity      ├ Events           ├ Beta
       └ Rotation          └ Special          ├ Sector
                              Situations       ├ FX
                                              ├ Factor
                                              └ Tail
       │                   │                   │
...
> **Pease Capital will operate as a multi-strategy investment platform combining regime-aware macro allocation, cross-asset trend following, quantitative equity selection, fundamental/catalyst investing and relationship-driven capital rotation. These strategies will compete for capital within a centralized portfolio framework. A separate Hedge Engine will identify and reduce unintended market, sector, currency, factor and tail exposures using the simplest effective hedge available. All strategies and hedges will be independently measured, versioned, stress-tested and attributed so that the fund can distinguish genuine alpha, systematic risk, hedging cost and luck.**
